# GammavetConfirmAvailabilityFn

Confirma disponibilidad diaria de conductor Gammavet desde respuesta WhatsApp
...
- **respuesta** (string): Texto o payload del boton recibido.
- **driver_phone** (string): Telefono WhatsApp del conductor, si no viene en el evento.
...
- The function name matches "GammavetConfirmAvailabilityFn"
...
- AWS CloudWatch Logs: `/aws/lambda/GammavetConfirmAvailabilityFn`
- Chask dashboard: Organization → Functions → GammavetConfirmAvailabilityFn
